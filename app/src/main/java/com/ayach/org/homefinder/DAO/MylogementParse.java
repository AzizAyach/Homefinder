 ...
 */
public class MylogementParse extends AsyncTask <String,Void,ArrayList<Logement>> {
    ...
    public MylogementParse(Context mContext)
    {
            ...
            try {
                if (params != null) {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        String userid = jsonobj.getString("iduser");
